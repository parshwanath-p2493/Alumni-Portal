...
export const api = {
  auth: {
    ...
    refreshToken: () =>
      fetchWithAuth("/auth/refresh", { method: "POST" }),
    logout: () =>
  ...
  projects: {
    ...
    like: (id: string) =>
      fetchWithAuth(`/projects/${id}/like`, { method: "POST" }),
    unlike: (id: string) =>
      fetchWithAuth(`/projects/${id}/like`, { method: "DELETE" }),
  },
  ...
  jobs: {
    ...
    showInterest: (id: string) => fetchWithAuth(`/jobs/${id}/interest`, { method: "POST" }),
    removeInterest: (id: string) => fetchWithAuth(`/jobs/${id}/interest`, { method: "DELETE" }),
    getInterestedUsers: (id: string) => fetchWithAuth(`/jobs/${id}/interested-users`),
  },
  ...
  events: {
    ...
    delete: (id: string) => fetchWithAuth(`/events/${id}`, { method: "DELETE" }),
    rsvp: (id: string, status: string) =>
      fetchWithAuth(`/events/${id}/rsvp`, {
        method: "POST",
        body: JSON.stringify({ status }),
  ...
  messages: {
    ...
    sendMessage: (recipientId: string, content: string, subject?: string) =>
      fetchWithAuth("/messages/sendmessage", {
        method: "POST",
        body: JSON.stringify({ recipient_id: recipientId, content, subject: subject || "" }),
      }),
    getMessages: (participantId: string, params = {}) =>
      fetchWithAuth(`/messages/${participantId}?` + new URLSearchParams(params as any).toString()),
    markAsRead: (messageId: string) => fetchWithAuth(`/messages/${messageId}/read`, { method: "PUT" }),
  },
  ...
  gallery: {
    ...
    getById: (id: string) => fetchWithAuth(`/gallery/${id}`),
    upload: (data: FormData) =>
      fetchWithAuth("/gallery/upload", { method: "POST", body: data }),
    delete: (id: string) => fetchWithAuth(`/gallery/${id}`, { method: "DELETE" }),
  },
  ...
  admin: {
    ...
    emailSettings: {
      ...
      test: () => fetchWithAuth("/admin/email-settings/test", { method: "POST" }),
      getTemplates: () => fetchWithAuth("/admin/email-settings/templates"),
      createTemplate: (data: any) =>
        fetchWithAuth("/admin/email-settings/templates", {
          method: "POST",
